...
<body>
          ...
          <img src="Assets/xyz-seeklogo.com.svg" width="50" height="30" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" aria-hidden="true" class="me-2" viewBox="0 0 24 24" style="filter: brightness(0) invert(1);"></img>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  <ul class="navbar-nav">
                    <li class="nav-item">
                      <a class="nav-link" id="list1" href="login.php">Login</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" aria-current="page" id="list1" href="register.php">Register</a>
                    </li>
                  </ul>
                </ul>
            </div>
    ...
    <section id="registrasi" style="background-color: #4b4e50;">
        <div class="container" style="width:50%">
            <main>
            <br>
            <form action="do_regis.php" method="POST" enctype="multipart/form-data">         
                <div class="row g-4">                 
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Lengkap" onkeyup = "check()">
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="password" class="form-control" name="pass2" id="pass2" placeholder="Confirm Password" onkeyup = "check()">
                    </div>
                </div>
                <button class="submit btn btn-dark mt-4" type="submit" name="regis" id="regis" disabled>Register</button>
            </form>
            <br>
            <br>
            </main>
    ...
    function check()
    {
        ...
        var button = document.getElementById("regis");

        if(uname.length < 1 || nama.length < 1 || pass.length < 1 || pass2.length < 1){
