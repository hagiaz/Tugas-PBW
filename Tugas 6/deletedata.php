...
<body>
  ...
  <div class="container">
  <form action="Domain/delete_data.php" method="POST" enctype="multipart/form-data">
    <div class="row d-flex justify-content-center pt-4 mb-5 login-panel">
    <h3 style = "padding-bottom:30px";>NPM Mahasiswa yang akan dihapus</h3>
        <div class="col-sm-6">
                <div class="mb-3">
        ...
        <div class="col-12 mb-3">
            <input class="form-check-input" type="checkbox" value="" name="terms2" id="terms2" onclick = "check()">
            <label class="form-check-label" for="terms" style="color: black;">
            Saya telah yakin bahwa data yang akan dihapus telah benar
            </label>
          </div>

        <button type="submit" class="btn btn-primary" name="delete" id="delete" style="width: 10rem; text-align: center;" disabled>Hapus Data</button>
        <br><br><br>
    </form>
    </section>
  </div>
  ...
  function check()
  {
    var check = document.getElementById("terms2");
